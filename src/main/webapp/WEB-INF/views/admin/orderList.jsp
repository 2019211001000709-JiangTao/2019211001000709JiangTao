	...
	<div class="container">
		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					<td>OID: ${o.orderId}</td>
					<td>order ${o.orderDate}</td>
					<%
						com.JiangTao.model.Order o=(com.JiangTao.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.JiangTao.dao.UserDao userDao=new com.JiangTao.dao.UserDao();
					...
					<td class="cart_total">${o.paymentId}
						<%
							...
							String paymentType=com.JiangTao.model.Payment.findByPaymentId(con,n);
						%>
